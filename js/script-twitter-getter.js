...
b);f[d]=u}else f[d].textContent=b}b="";G?(t&&(E(a[d]),w&&E(k[d])),w&&(b+='<div class="user">'+p(k[d].innerHTML)+"</div>"),b+='<p class="twitter-getter-tweet">'+p(a[d].innerHTML)+'</p>',y&&(b=J?b+('<p class="twitter-getter-time"><a href="'+n[d]+'">'+f[d].getAttribute("aria-label")+"</a></p>"):b+('<a target="_blank" href="https://twitter.com/anoffsinger" class="twitter-getter-time">'+f[d].getAttribute("aria-label")+"</a>"))):(w&&(b+='<p class="user">'+k[d].textContent+"</p>"),b+='<p class="tweet">'+a[d].textContent+"</p>",y&&(b+='<p class="twitter-getter-time">'+f[d].textContent+"</p>"));H&&(b+=
